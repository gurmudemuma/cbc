...
echo -e "${GREEN}Redeploying v1.9 Sequence 10 with ECTA-only endorsement${NC}"
...
# Approve for all orgs with ECTA-only policy
...
echo -e "${GREEN}v1.9 Sequence 10 Deployed!${NC}"
