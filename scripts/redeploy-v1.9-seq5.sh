...
echo -e "${GREEN}Redeploying v1.9 Sequence 5${NC}"
...
peer lifecycle chaincode approveformyorg \
    ...
    --tls \
    --cafile ${CRYPTO_PATH}/ordererOrganizations/orderer.example.com/orderers/orderer1.orderer.example.com/msp/tlscacerts/tlsca.orderer.example.com-cert.pem 2>&1 | tail -3
...
echo -e "${GREEN}v1.9 Sequence 5 Deployed!${NC}"
