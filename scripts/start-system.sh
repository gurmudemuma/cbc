...
# Wait a bit longer for peers to fully start and bind ports
sleep 15

# Install blockchain chaincode and create channel
echo "Installing blockchain (channel creation and chaincode deployment)..."
bash ./install-blockchain.sh
if [ $? -ne 0 ]; then
    echo "[ERROR] Blockchain installation failed."
    exit 1
fi
echo "[OK] Blockchain installed"
echo ""
