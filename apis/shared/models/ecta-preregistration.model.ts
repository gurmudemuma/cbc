 ...
 * Based on Official Ethiopian Coffee & Tea Authority (ECTA) Procedures
 * Reference: ECTA Official Procedures Manual, Directive 1106/2025
 *
 * OFFICIAL ECTA REGISTRATION STAGES:
 * Stage 1: Business Registration & Legal Status Verification
...
export type ExporterStatus =
  | 'STAGE_1_PENDING' // Business registration verification in progress
  | 'STAGE_1_APPROVED' // Business registration verified
  | 'STAGE_1_REJECTED' // Business registration rejected
  | 'STAGE_2_PENDING' // Facility inspection in progress
  | 'STAGE_2_APPROVED' // Facility inspection passed
  | 'STAGE_2_REJECTED' // Facility inspection failed
  | 'STAGE_3_PENDING' // Laboratory certification in progress
  | 'STAGE_3_APPROVED' // Laboratory certified
  | 'STAGE_3_REJECTED' // Laboratory certification rejected
  | 'STAGE_4_PENDING' // Competence certificate application in progress
  | 'STAGE_4_APPROVED' // Competence certificate issued
  | 'STAGE_4_REJECTED' // Competence certificate rejected
  | 'STAGE_5_PENDING' // Export license application in progress
  | 'STAGE_5_APPROVED' // Export license issued
  | 'STAGE_5_REJECTED' // Export license rejected
  | 'ACTIVE' // Fully registered and licensed
  | 'SUSPENDED' // License suspended (compliance violation)
  | 'REVOKED' // License revoked (serious violation)
  | 'EXPIRED'; // License expired (renewal required)
...
// ECTA Registration Stage Type
export type ECTARegistrationStage = 1 | 2 | 3 | 4 | 5;
