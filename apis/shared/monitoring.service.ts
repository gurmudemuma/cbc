...
export class MonitoringService {
   ...
   */
  public trackBlockchainTransaction(operation: string, duration: number, success: boolean): void {
    this.recordMetric({
   ...
   */
  public trackExportDecision(exportId: string, stage: string, approved: boolean): void {
    const metricType = approved ? MetricType.EXPORTS_APPROVED : MetricType.EXPORTS_REJECTED;
