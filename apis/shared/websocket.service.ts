...
export class WebSocketService {
  ...
  public emitExportUpdate(exportId: string, data: any): void {
    ...
    logger.info('Emitted update for export', { exportId });
  }
  ...
  public emitNewExport(organization: string, data: any): void {
    ...
    logger.info('Emitted new export to organization', { organization });
  }
  ...
  public emitFXApproval(exportId: string, data: any): void {
    ...
    logger.info('Emitted FX approval for export', { exportId });
  }
  ...
  public emitFXRejection(exportId: string, data: any): void {
    ...
    logger.info('Emitted FX rejection for export', { exportId });
  }
  ...
  public emitQualityCertification(exportId: string, data: any): void {
    ...
    logger.info('Emitted quality certification for export', { exportId });
  }
  ...
  public emitQualityRejection(exportId: string, data: any): void {
    ...
    logger.info('Emitted quality rejection for export', { exportId });
  }
  ...
  public emitShipmentScheduled(exportId: string, data: any): void {
    ...
    logger.info('Emitted shipment scheduled for export', { exportId });
  }
  ...
  public emitShipmentConfirmed(exportId: string, data: any): void {
    ...
    logger.info('Emitted shipment confirmed for export', { exportId });
  }
  ...
  public emitExportCompleted(exportId: string, data: any): void {
    ...
    logger.info('Emitted export completed', { exportId });
  }
  ...
  public emitExportCancelled(exportId: string, data: any): void {
    ...
    logger.info('Emitted export cancelled', { exportId });
  }

  public emitDocumentUploaded(
    exportId: string,
    docType: string,
    version: number,
    cid: string
    ...
    logger.info('Emitted document uploaded for export', { exportId });
  }
  ...
  public emitDocumentDeleted(exportId: string, docType: string, version: number): void {
    ...
    logger.info('Emitted document deleted for export', { exportId });
  }
