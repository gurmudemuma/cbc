...
export const CreateExportSchema = z.object({
  ...
  ecxLotNumber: z.string().max(50, 'ECX lot number must not exceed 50 characters').optional(),
 ...
 */
export const ScheduleShipmentSchema = z
  .object({
...
export const RegisterUserSchema = z.object({
  ...
  role: z.enum(['exporter', 'bank', 'admin', 'user', 'shipper', 'customs']).optional(),
});
...
export const ExportFilterSchema = z.object({
  ...
  commercialbankId: z.string().optional(),
