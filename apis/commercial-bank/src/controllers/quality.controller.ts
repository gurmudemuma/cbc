...
export class QualityController {
  ...
  public getPendingExports = async (
    ...
    try {
      ...
      const result = await contract.evaluateTransaction('GetExportsByStatus', 'FX_APPROVED');
  ...
  public rejectQuality = async (
    ...
    try {
      ...
      await contract.submitTransaction('RejectQuality', exportId, rejectionReason, rejectedBy);
