...
import exporterAuthRoutes from './routes/exporter-auth.routes';
import exporterExportRoutes from './routes/exporter-export.routes';
import exporterProfileRoutes from './routes/exporter-profile.routes';
import exporterPreregistrationRoutes from './routes/exporter-preregistration.routes';
...
// Exporter Portal Routes (merged from exporter-portal service)
app.use('/api/exporter/auth', authLimiter, exporterAuthRoutes);
app.use('/api/exporter/exports', apiLimiter, exporterExportRoutes);
app.use('/api/exporter/profile', apiLimiter, exporterProfileRoutes);
app.use('/api/exporter/preregistration', apiLimiter, exporterPreregistrationRoutes);
