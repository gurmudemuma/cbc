...
router.get('/exports', requireOrganization(['ecta']), exportController.getAllExports);

// Get single export - ECTA can view all exports
router.get('/exports/:exportId', requireOrganization(['ecta']), exportController.getExport);

// Get pending quality inspections - ECTA specific action
router.get(
  '/exports/pending/quality',
...
router.post(
  '/exports/:exportId/quality/approve',
...
router.post(
  '/exports/:exportId/quality/reject',
...
router.post(
  '/exports/:exportId/quality/certificate',
...
router.post(
  '/exports/:exportId/license/reject',
...
router.post(
  '/exports/:exportId/contract/reject',
