...
router.post('/certify', validateQualityCertificate, qualityController.issueQualityCertificate);

// Reject quality
router.post('/reject', validateQualityRejection, qualityController.rejectQuality);

// Request reinspection after rejection
router.post('/reinspect/:exportId', qualityController.requestReinspection);

// Issue certificate of origin
router.post('/origin-certificate/:exportId', qualityController.issueOriginCertificate);
