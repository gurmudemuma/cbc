/**
 * Buyer Routes
 * API endpoints for buyer selection and management
 */
...
const router = Router();
const logger = createLogger('BuyerRoutes');

/**
 * GET /api/buyers
 * Get all available buyers (requires FULLY_QUALIFIED)
 */
router.get('/buyers', authenticateToken, requireFullyQualified, (req, res) => {
  try {
 ...
 */
router.get('/buyers/:buyerId', authenticateToken, requireFullyQualified, (req, res) => {
  try {
 ...
 */
router.post('/buyers/search', authenticateToken, requireFullyQualified, (req, res) => {
  try {
...
/**
 * GET /api/buyers/filters/countries
 * Get all unique countries (requires FULLY_QUALIFIED)
 */
router.get('/buyers/filters/countries', authenticateToken, requireFullyQualified, (req, res) => {
  try {
...
/**
 * GET /api/buyers/filters/coffee-types
 * Get all unique coffee types (requires FULLY_QUALIFIED)
 */
router.get('/buyers/filters/coffee-types', authenticateToken, requireFullyQualified, (req, res) => {
  try {
...
/**
 * GET /api/buyers/filters/payment-terms
 * Get all unique payment terms (requires FULLY_QUALIFIED)
 */
router.get('/buyers/filters/payment-terms', authenticateToken, requireFullyQualified, (req, res) => {
  try {
