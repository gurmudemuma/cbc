...
router.get('/competence/:certificateId/download', controller.downloadCompetenceCertificate);

// Get competence certificate metadata
router.get('/competence/:certificateId/metadata', controller.getCompetenceCertificateMetadata);
...
router.get('/licenses/:licenseId/download', controller.downloadExportLicense);

// Get export license metadata
router.get('/licenses/:licenseId/metadata', controller.getExportLicenseMetadata);
