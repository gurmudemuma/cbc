    ...
    public getExporterDashboard = async (
        ...
        try {
            ...
            logger.info('Dashboard data fetched', {
                ...
                hasTaster: !!taster,
                hasCompetence: !!competenceCertificate,
                hasLicense: !!exportLicense,
                laboratoryCertNumber: laboratory?.certificationNumber,
                tasterCertNumber: taster?.proficiencyCertificateNumber,
                competenceCertNumber: competenceCertificate?.certificateNumber,
                licenseNumber: exportLicense?.licenseNumber,
                eicNumber: exportLicense?.eicRegistrationNumber,
            });
