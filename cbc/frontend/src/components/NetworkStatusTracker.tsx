...
import NetworkCertificates from './NetworkCertificates';

interface NetworkStatusTrackerProps {
  submission: any;
}

const NetworkStatusTracker = ({ submission }: NetworkStatusTrackerProps): JSX.Element => {
        ...
        <CardContent>
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={12} md={6}>
              <Typography variant="h6">Network Reference Number</Typography>
              <Typography variant="h4">{submission.networkReferenceNumber}</Typography>
            </Grid>
