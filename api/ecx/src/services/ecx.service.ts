...
export class ECXService {
   ...
   */
  async verifyOwnership(lotNumber: string, exporterName: string, exporterTIN: string): Promise<boolean> {
    try {
   ...
   */
  async processVerificationRequest(request: ECXVerificationRequest): Promise<ECXVerificationResponse> {
    try {
