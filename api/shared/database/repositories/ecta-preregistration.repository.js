...
exports.EctaPreRegistrationRepository = void 0;
class EctaPreRegistrationRepository {
    constructor(pool) {
        this.pool = pool;
    }
    // ============================================================================
    // EXPORTER PROFILES
    // ============================================================================
    async createExporterProfile(profile) {
        const query = `
    ...
    async getExporterProfileById(exporterId) {
    ...
    async getExporterProfileByUserId(userId) {
        const query = 'SELECT * FROM exporter_profiles WHERE user_id = $1';
        const result = await this.pool.query(query, [userId]);
        return result.rows[0] ? this.mapExporterProfile(result.rows[0]) : null;
    }
    async getAllExporterProfiles() {
    ...
    async getPendingExporterProfiles() {
    ...
    async updateExporterProfileStatus(exporterId, status, approvedBy, rejectionReason) {
        const query = `
    ...
    async getLaboratoryByExporterId(exporterId) {
    ...
    async certifyLaboratory(laboratoryId, certificationNumber, certifiedDate, expiryDate, inspectedBy) {
        const query = `
    ...
    async getTasterByExporterId(exporterId) {
    ...
    // ============================================================================
    async createCompetenceCertificate(certificate) {
        const query = `
    ...
    async getCompetenceCertificateByExporterId(exporterId) {
    ...
    async getPendingCompetenceCertificates() {
    ...
    // EXPORT LICENSES
    // ============================================================================
    async createExportLicense(license) {
        const query = `
    ...
    async getExportLicenseByExporterId(exporterId) {
    ...
    async getPendingExportLicenses() {
    ...
    async getCoffeeLotByEcxNumber(ecxLotNumber) {
    ...
    async getQualityInspectionById(inspectionId) {
    ...
    // SALES CONTRACTS
    // ============================================================================
    async createSalesContract(contract) {
        const query = `
    ...
    async getSalesContractById(contractId) {
...
exports.EctaPreRegistrationRepository = EctaPreRegistrationRepository;
//# sourceMappingURL=ecta-preregistration.repository.js.map