...
async function invokeChaincode(functionName, ...args) {
  ...
  // Build peer addresses for ALL organizations to satisfy endorsement policy
  const peerAddresses = [
    `--peerAddresses peer0.ecta.example.com:7051 --tlsRootCertFiles ${CRYPTO_PATH}/peerOrganizations/ecta.example.com/peers/peer0.ecta.example.com/tls/ca.crt`,
    `--peerAddresses peer0.bank.example.com:9051 --tlsRootCertFiles ${CRYPTO_PATH}/peerOrganizations/bank.example.com/peers/peer0.bank.example.com/tls/ca.crt`,
    `--peerAddresses peer0.nbe.example.com:10051 --tlsRootCertFiles ${CRYPTO_PATH}/peerOrganizations/nbe.example.com/peers/peer0.nbe.example.com/tls/ca.crt`,
    `--peerAddresses peer0.customs.example.com:11051 --tlsRootCertFiles ${CRYPTO_PATH}/peerOrganizations/customs.example.com/peers/peer0.customs.example.com/tls/ca.crt`,
