...
exports.ectaPreRegistrationService = exports.EctaPreRegistrationService = void 0;
const ecta_preregistration_repository_1 = require("../database/repositories/ecta-preregistration.repository");
const pool_1 = require("../database/pool");
const pool = (0, pool_1.getPool)();
class EctaPreRegistrationService {
    constructor() {
        this.repository = new ecta_preregistration_repository_1.EctaPreRegistrationRepository(pool);
    }
    static getInstance() {
     ...
     */
    getMinimumCapitalRequirement(businessType) {
        const requirements = {
            PRIVATE: 15000000, // ETB 15 million
            TRADE_ASSOCIATION: 20000000, // ETB 20 million
            JOINT_STOCK: 20000000, // ETB 20 million
            LLC: 20000000, // ETB 20 million
            FARMER: 0, // Exempt
        };
     ...
     */
    async validateExporter(exporterId) {
        const validation = {
            isValid: false,
            exporterId,
     ...
     */
    async canCreateExportRequest(exporterId) {
     ...
     */
    async validateExportPermitRequirements(data) {
        const issues = [];
