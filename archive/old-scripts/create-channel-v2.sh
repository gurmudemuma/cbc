#!/bin/bash
# Create and join channel script for Fabric 2.3+ (no system channel)
...
echo "========================================="
echo "Creating channel: $CHANNEL_NAME (Fabric 2.3+ method)"
echo "========================================="

# Generate channel genesis block using configtxgen
