...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // setApiBaseUrl(apiUrl); // Removed to allow Vite proxy to handle routing to different services

      // Use standard auth endpoint with /api prefix for Vite proxy routing
