...
import { DashboardContainer, ActivityCard, QuickActionsCard, PulseChip } from './Dashboard.styles';
...
const Dashboard = ({ user, org }: DashboardProps): JSX.Element => {
  ...
  const calculateTrend = (current: number, previous: number | undefined): { value: number; direction: 'up' | 'down' | 'neutral' } => {
