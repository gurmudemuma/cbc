        ...
        <Grid item xs={12} md={8}>
          ...
          <Paper
            sx={{
              p: 2,
              mb: 3,
              bgcolor: `${getStatusColor(exportData.status)}.light`,
              border: 1,
              borderColor: `${getStatusColor(exportData.status)}.main`,
            }}
          >
            <Stack direction="row" alignItems="center" spacing={2}>
                  ...
                  <CardContent>
                    ...
                    <List>
                      ...
                      <ListItem>
                        <ListItemText
                          primary="Quantity"
                          secondary={`${exportData.quantity.toLocaleString()} kg`}
                        />
                      </ListItem>
                      <Divider />
                      <ListItem>
                        ...
                        <ListItemText
                          ...
                          secondary={exportData.destinationCountry}
                        />
                      </ListItem>
                      <Divider />
                      <ListItem>
                        ...
                        <ListItemText
                          ...
                          secondary={`${exportData.estimatedValue.toLocaleString()}`}
                        />
                      </ListItem>
                      <Divider />
                      <ListItem>
                        ...
                        <ListItemText
                          primary="Created At"
                          secondary={new Date(exportData.createdAt).toLocaleString()}
                        />
                      </ListItem>
                    </List>
                  </CardContent>
                    ...
                    <CardContent>
                      ...
                      <List>
                        <ListItem>
                          <ListItemText
                            primary="Approved By"
                            secondary={exportData.bankingApprovedBy}
                          />
                        </ListItem>
                        <Divider />
                        <ListItem>
                          <ListItemText
                            primary="Approved At"
                            secondary={
                              exportData.bankingApprovedAt
                                ? new Date(exportData.bankingApprovedAt).toLocaleString()
                                : '-'
                            }
                          />
                        </ListItem>
                      ...
                      <List>
                        <ListItem>
                          <ListItemText
                            ...
                            secondary={exportData.bankingRejectionReason}
                          />
                        </ListItem>
                      </List>
                    </CardContent>
                    ...
                    <CardContent>
                      ...
                      <List>
                        <ListItem>
                          <ListItemText
                            primary="Rejection Reason"
                            secondary={exportData.fxRejectionReason}
                          />
                        </ListItem>
                      </List>
                    </CardContent>
                      ...
                      <List>
                        <ListItem>
                          <ListItemText
                            ...
                            secondary={exportData.qualityCertId}
                          />
                        </ListItem>
                        <Divider />
                        <ListItem>
                          <ListItemText
                            ...
                            secondary={exportData.qualityGrade}
                          />
                        </ListItem>
                        <Divider />
                        <ListItem>
                          <ListItemText
                            primary="Certified By"
                            secondary={exportData.qualityCertifiedBy}
                          />
                        </ListItem>
                        <Divider />
                        <ListItem>
                    ...
                    <CardContent>
                      ...
                      <List>
                        <ListItem>
                          <ListItemText
                            primary="Rejection Reason"
                            secondary={exportData.qualityRejectionReason}
                          />
                        </ListItem>
                      </List>
                    </CardContent>
            ...
            {history && history.length > 0 && (
              <WorkflowTimeline
                events={history.map((record) => ({
                  id: record.txId || record.historyId || Math.random().toString(),
                  timestamp: record.timestamp || record.createdAt,
                  eventType: `Status changed to ${record.record?.status || record.newStatus}`,
                  oldStatus: record.oldStatus,
                  newStatus: record.record?.status || record.newStatus,
                  changedBy: record.record?.updatedBy || record.changedBy || 'System',
                  organization: record.organization || 'System',
